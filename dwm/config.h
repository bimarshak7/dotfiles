...
static const char *fonts[]          = { "Adobe Utopia:size=14" };
...
static const char *dmenucmd[] = { "rofi", "-no-config", "-no-lazy-grab", "-show", "drun", "-modi", "drun", "-theme", "~/.config/polybar/scripts/rofi/config.rasi", NULL };
